...
int main(int argc, char* argv[]) {
	...
	auto contextOpt = model.create_context();
	...
	context.medium = [&model] (pms::pumas::Context *context, pms::pumas::State *state, pms::pumas::Medium **medium_ptr, double *step_ptr) -> pms::pumas::Step {
