...
template <typename CellTopology, typename RequiredTopology, typename Type>
using EnableIfSame = std::enable_if_t<std::is_same_v<CellTopology, RequiredTopology>, Type>;

/* ----- MHFE ----- */
struct MHFEDelta {
	template <typename CellTopology, typename Real>
	inline static EnableIfSame<CellTopology, TopoTriangle, Real> get(const Real& alpha_i, const Real& alpha,
...
struct MHFELumping {
	template <typename CellTopology, typename Real>
	inline static Real get(const Real& alpha_i, const Real& alpha,
			const Real& lambda, const Real& beta,
			const Real& a, const Real& c, const Real& l,
			const Real& mes, const Real& tau,
			const Real& BinvEl) {
