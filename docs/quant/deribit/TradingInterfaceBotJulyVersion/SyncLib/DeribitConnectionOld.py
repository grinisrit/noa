...
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Utils.AvailableInstruments import Instrument
...
if __name__ == "__main__":
    ...
    deribit = DeribitConnectionOld(api_key=config('Deribit_API'))
