...
try:
    ...
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.ExternalModules.AbstractExternal import AbstractExternal
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.InstrumentManager.AbstractInstrument import AbstractInstrument
