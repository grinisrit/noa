...
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Utils import Currency
...
async def scrap_available_instruments_by_extended_config(currency: Currency, cfg):
    ...
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.Utils import InstrumentType, get_ticker_by_instrument_request
