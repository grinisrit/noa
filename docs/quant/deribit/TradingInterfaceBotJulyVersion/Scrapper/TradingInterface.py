...
from docs.quant.deribit.TradingInterfaceBotJulyVersion.InstrumentManager import AbstractInstrumentInfo
from docs.quant.deribit.TradingInterfaceBotJulyVersion.DataBase import *
from docs.quant.deribit.TradingInterfaceBotJulyVersion.OrderManager import OrderManager
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Utils import *
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Subsciption import *
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Strategy import *
from docs.quant.deribit.TradingInterfaceBotJulyVersion.InstrumentManager import InstrumentManager

from docs.quant.deribit.TradingInterfaceBotJulyVersion.SyncLib.AvailableRequests import get_ticker_by_instrument_request
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Scrapper.ScrapperWithPreSelectedMaturities import scrap_available_instruments_by_extended_config
...
async def scrap_available_instruments(currency: Currency, cfg):
    ...
    """
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.SyncLib.AvailableRequests import get_instruments_by_currency_request
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.Utils.AvailableInstrumentType import InstrumentType
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.SyncLib.Scrapper import send_request
    import pandas as pd
    import numpy as np
...
class DeribitClient(Thread, WebSocketApp):
    ...
    def __init__(self, cfg, cfg_path: str, loopB, client_currency: Currency,
        ...
        with open(sys.path[1] + "/docs/quant/deribit/TradingInterfaceBotJulyVersion/developerConfiguration.yaml", "r") as _file:
