...
from docs.quant.deribit.TradingInterfaceBotJulyVersion.Utils import ConfigRoot, get_positions_request, Currency, auth_message

if TYPE_CHECKING:
    from docs.quant.deribit.TradingInterfaceBotJulyVersion.Strategy import AbstractStrategy
...
if __name__ == '__main__':
    with open(sys.path[1] + "/docs/quant/deribit/TradingInterfaceBotJulyVersion/configuration.yaml", "r") as ymlfile:
