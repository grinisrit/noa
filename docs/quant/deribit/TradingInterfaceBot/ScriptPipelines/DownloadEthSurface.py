...
from docs.quant.deribit.TradingInterfaceBot.Scrapper.TradingInterface import validate_configuration_file, DeribitClient
...
async def scrap_all_instruments_from_currency(currency: Currency, cfg):
    ...
    """
    from docs.quant.deribit.TradingInterfaceBot.SyncLib.AvailableRequests import get_instruments_by_currency_request, get_ticker_by_instrument_request
