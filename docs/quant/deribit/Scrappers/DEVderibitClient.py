...
from docs.quant.deribit.DataBase.HDF5NewDaemon import HDF5Daemon

from docs.quant.deribit.DataBase.MySQLNewDaemon import MySqlDaemon
from docs.quant.deribit.Utils import MSG_LIST
from docs.quant.deribit.Utils.AvailableCurrencies import Currency
from docs.quant.deribit.SyncLib.AvailableRequests import get_ticker_by_instrument_request
from docs.quant.deribit.Scrappers.AbstractSubscription import AbstractSubscription, OrderBookSubscriptionCONSTANT
...
def scrap_available_instruments(currency: Currency, cfg):
    from docs.quant.deribit.SyncLib.AvailableRequests import get_instruments_by_currency_request
    from docs.quant.deribit.Utils.AvailableInstrumentType import InstrumentType
    from docs.quant.deribit.SyncLib.Scrapper import send_request
    import pandas as pd
    import numpy as np
